...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003153292987').split()]  # Channel id for auto indexing (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002482748550")# Channels for force sub (make sure bot is admin)
